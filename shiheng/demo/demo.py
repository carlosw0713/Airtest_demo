...
if not cli_setup():
    ...
    auto_setup(__file__, logdir=True, devices=["Android://127.0.0.1:5037/7148c452"])
    # auto_setup(__file__, logdir=True, devices=["127.0.0.1:5037/10.254.60.1:5555"]) #远程
    # auto_setup(__file__, logdir=True, devices=["Android://127.0.0.1:5037/7148c452","Android://127.0.0.1:5037/7148c66"])
